package com.yopheu.iolist.persistance;
...
import com.yopheu.iolist.persistance.sql.BuyerSQL;

/*
 * DBMS에 Query 를 보내고, 데이터를 받을 method 선언
 * 인터페이스에 Query method 를 선언만 해 두면
 * Mybatis 의 SessionFactiory 가 
...
public interface BuyerDao {
	 ...
	 * 		SELECT * FROM tbl_buyer WHERE buid = '00001'
	 * 
	 * 조회대상이 PK 가 아닌경우
